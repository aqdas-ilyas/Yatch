...
const NeumorphismButton = props => {
  ...
  const buttonFaceStyle = {
    borderRadius: props.circlebutton ? size * 5:null,
    paddingHorizontal: props.circlebutton ? size * 3 : (size * 5) / 1.8,
    paddingVertical: props.circlebutton ? size * 3.5 : (size * 7) / 2,
  };

  return (
    <TouchableWithoutFeedback
      onPress={props.nopress ? console.log('MOB') : () => props.onpress()}
