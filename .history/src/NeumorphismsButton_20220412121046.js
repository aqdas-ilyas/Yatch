...
const NeumorphismButton = props => {
  ...
  const buttonFaceStyle = {
    ...
    padding: props.circlebutton ? size * 2 : (size * 5) / 1.8,
    paddingVertical: props.circlebutton ? size * 2 : (size * 7) / 2,
  };
    ...
    <TouchableWithoutFeedback
      ...
      <View
        style={[
          ...
          buttonOuterStyle,
          {
            backgroundColor: props.MOB ? '#640D02' : null,
            borderRadius: 30,
            marginBottom: props.MOB ? 20 : null,
          },
        ]}>
