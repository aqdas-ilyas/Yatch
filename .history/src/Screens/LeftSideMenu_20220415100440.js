        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Text style={{...styles.text, paddingBottom:40, fontSize: 22}}>
                Speed
              </Text>
              <Text style={{...styles.text, fontSize: 55,marginTop:20, marginHorizontal: 5}}>
                9.5
              </Text>
              <Text style={{...styles.text,marginBottom:10, fontSize: 20}}>kn</Text>
            </View>
