    ...
    return (
      <View style={{flex: 1}}>
        <View
          ...
          <Text style={{fontSize: 40, color: '#AAAAAA',fontWeight:'bold', textAlign: 'center'}}>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          <View
            ...
            <View
              ...
              <Text style={{fontSize: 18,fontWeight:'bold', color: '#AAAAAA'}}>WATER TEMP</Text>
              <Text style={{fontSize: 18,fontWeight:'bold', color: '#AAAAAA', marginLeft: 30}}>
                °C
              </Text>
            </View>
