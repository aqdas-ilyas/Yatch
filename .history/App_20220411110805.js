        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Text style={{...styles.text, fontSize: 12}}>Speed</Text>
              <Text style={{...styles.text, fontSize: 32, marginHorizontal: 5}}>
                9.5
              </Text>
              <Text style={{...styles.text, fontSize: 12}}>kn</Text>
            </View>
            ...
            <View
              ...
              <Text style={{...styles.text, fontSize: 12}}>AWA</Text>
              <Text style={{...styles.text, fontSize: 32, marginHorizontal: 5}}>
                -151
              </Text>
            ...
            <View
              ...
              <Text style={{...styles.text, fontSize: 12}}>AWS</Text>
              <Text style={{...styles.text, fontSize: 32, marginHorizontal: 5}}>
                18.6
              </Text>
              <Text style={{...styles.text, fontSize: 12}}>kn</Text>
