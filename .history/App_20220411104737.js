    ...
    <View style={styles.container}>
      ...
      <View style={{alignItems:"center"}}>
        <SwitchButton
          ...
          switchBorderColor="black" // optional: switch border color --- default #d4d4d4
          switchBackgroundColor="#000" // optional: switch background color --- default #fff
          btnBorderColor="#00a4b9" // optional: button border color --- default #00a4b9
          btnBackgroundColor="#000" // optional: button background color --- default #00bcd4
        ...
        <View>
          <TouchableOpacity style={{backgroundColor:"#4B4B4B", padding:10, borderRadius:10}}>
