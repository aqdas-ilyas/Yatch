    ...
    <View style={styles.container}>
      ...
      <View
        ...
        <View style={{alignItems: 'center'}}>
          ...
          <Text style={{...styles.text}}>hydro gen bb</Text>

          <View style={{backgroundColor: '#AAAAAA', padding: 5, borderRadius:20}}>
            <View style={{backgroundColor: '#1F1F1F', padding: 10, borderRadius:20}}>
              <Text style={{...styles.text}}>1.2 kW</Text>
            </View>
          </View>
        </View>
      </View>
